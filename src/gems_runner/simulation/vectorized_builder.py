...
All 18 other :class:`~gems_runner.expression.visitor.ExpressionVisitor` methods are
...
from gems_runner.expression.visitor import (
    ExpressionVisitor,
    ExpressionVisitorOperations,
    visit,
)
from gems_runner.model.port import PortFieldId
...
class VectorizedBuilderBase(ExpressionVisitor[VectorizedExpr], Generic[T_expr]):
    ...
    Implements all :class:`~gems_runner.expression.visitor.ExpressionVisitor` methods
