...
import gems_runner.expression.port_operator
import gems_runner.expression.scenario_operator
    ...
    def __post_init__(self) -> None:
        valid_names = [
            ...
            for _, cls in inspect.getmembers(
                gems_runner.expression.port_operator, inspect.isclass
            )
            if issubclass(cls, gems_runner.expression.port_operator.PortAggregator)
        ]
