...
class ContainsDualOrReducedCostVisitor(ExpressionVisitor[bool]):
    """Returns True if the expression contains any DualNode or ReducedCostNode."""
...
def contains_dual_or_reduced_cost(expr: ExpressionNode) -> bool:
    ...
    return visit(expr, ContainsDualOrReducedCostVisitor())
