...
class TestAntaresStudyConverterReal:
    ...
    def study_path(self):
        return Path(
            "tests/input_converter/resources/mini_test_batterie_BP23/converted_test/mini_test_batterie_BP23"
        )

    @pytest.fixture
    def scenario_builder_file(self, study_path):
        return study_path / "settings" / "modeler-scenariobuilder.dat"
    ...
    def test_scenario_builder_file_copied(
        ...
        if not study_path.exists():
            pytest.skip("Study path does not exist")
